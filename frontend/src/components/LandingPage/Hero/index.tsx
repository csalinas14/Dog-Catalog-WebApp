...
const Hero = ({ variants }: { variants: Variants }) => {
  return (
    <motion.div
          ...
          <motion.div variants={variants}>
            <div className='flex flex-col gap-8 p-3 text-center items-center sm:pl-20 md:max-w-[800px] lg:pl-28 lg:pt-10 lg:text-left lg:items-start'>
              ...
              <p className='lg:text-lg xl:text-3xl'>
                Interested in learning about pets? Look through our extensive
                pet catalog with all kinds of different dog and cat breeds. Find
                your favorite among all these adorable animals!
              </p>
